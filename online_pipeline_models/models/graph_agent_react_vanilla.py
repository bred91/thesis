...
from utils.config import NUM_CTX, EMBEDDING_MODEL, COMMITS_COLLECTION_NAME, CHROMA_PERSIST_DIR, \
...
# ---- GraphAgentReactVanilla Class ----
class GraphAgentReactVanilla(BaseChatPipeline):
    def __init__(self):
        super().__init__()
        self.graph = agent
